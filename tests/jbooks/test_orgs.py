...
def test_legacy_long_form_document_orgs_translate_to_workbook_codes():
    ...
    assert workbook_org("Defense_Media_Activity") == "DMA"
    assert workbook_org("Defense_Production_Act_Purchases") == "DPA"
    ...
    assert workbook_org("Joint_Urgent_Operational_Needs_Fund") == "JUON"
